...
<div>
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type="text" name="merek" class="form-control" autocomplete="off" autofocus required>
        </div>
        <div>
...
if (isset($_POST['simpan'])) {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        if ($ukuran < 1044070) {
            ...
            mysqli_query($koneksi, "INSERT INTO barang VALUES(null,'$id_kategori','$nm_barang','$jumlah','$nama_c','$merek')") or die(mysqli_error($koneksi));
?>
            <script>
                swal({
                    title: "Success!",
